            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" action="" data-parsley-validate="true" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                    ...
                    <div class="col-lg-9">
                      <input type="text" name="nama_lengkap" class="form-control" value="<?php echo $query->nama_lengkap; ?>" placeholder="Nama Lengkap" required autofocus>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-9">
                      <input type="password" name="password2" class="form-control" value="" placeholder="Ulangi Password">
                    </div>
                  </div>
                  <hr>
