            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" action="" data-parsley-validate="true" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                    ...
                    <div class="col-lg-9">
                      <input type="text" name="posko" class="form-control" value="" placeholder="Posko" required autofocus>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label col-lg-3">Desa</label>
                    <div class="col-lg-9">
                      <input type="text" name="desa" class="form-control" value="" placeholder="Desa" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label col-lg-3">Nama</label>
                    <div class="col-lg-9">
                      <input type="text" name="nama_lengkap" class="form-control" value="" placeholder="Nama" required>
                    </div>
                  </div>
                  <div class="form-group">
